...
class Model:
    ...
    def _create_vocab_sentencepiece(self):
        ...
        tokens: list[bytes] = [f"[PAD{i}]".encode() for i in range(vocab_size)]
    ...
    def set_vocab(self):
        ...
        for token_id in range(vocab_size):
            ...
            if token_text == b"\x00":
                ...
                token_text = f"<{token_text}>".encode()
...
class Rwkv6Model(Model):
    ...
    def set_vocab(self):
        ...
        with open(self.dir_model / "rwkv_vocab_v20230424.txt", encoding="utf-8") as f:
            lines = f.readlines()
            for line in lines:
                parts = line.split(" ")
                assert len(parts) >= 3
...
class MambaModel(Model):
    ...
    def set_gguf_parameters(self):
        ...
        if self.find_hparam(["model_type"], optional=True) == "falcon_mamba":
