...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("created_by_role", sa.String(50), nullable=True),
    ...
    op.create_table(
        ...
        sa.Column("model_fmt", sa.String(50), nullable=True),
        sa.Column("quantization_level", sa.String(50), nullable=True),
        sa.Column("modelfile", sa.String(1000), nullable=True),
        ...
        sa.Column("process_message", sa.String(500), nullable=True),
        sa.Column("updated_at", sa.DateTime(), nullable=True),
        sa.Column("created_at", sa.DateTime(), nullable=True),
        sa.Column("created_by", models.sqlalchemy_types.GUID(), nullable=True),
