...
if curl -I --silent --fail --location "https://ollama.com/download/ollama-linux-${ARCH}.tgz${VER_PARAM}" >/dev/null ; then
    ...
    curl --http1.1 --retry 10 --fail --show-error --location --progress-bar \
    ...
    curl --http1.1 --retry 10 --fail --show-error --location --progress-bar -o "$TEMP_DIR/ollama"\
