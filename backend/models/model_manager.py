...
class Model(Base):
    ...
    ollama_model_name: Mapped[str] = mapped_column(String(255), nullable=True)
    ollama_template: Mapped[Optional[str]] = mapped_column(Text, nullable=True)
    ollama_architecture: Mapped[Optional[str]] = mapped_column(String(100), nullable=True)
    ...
    provider: Mapped[str] = mapped_column(String(100), default="", nullable=True)
    digest: Mapped[str] = mapped_column(String(255), default="", nullable=True)
    source: Mapped[str] = mapped_column(String(255), default="", nullable=True)
    ...
    parameter: Mapped[str] = mapped_column(String(100), default="", nullable=True)
    size: Mapped[int] = mapped_column(BIGINT, default=0, nullable=True)
    model_fmt: Mapped[str] = mapped_column(String(50), default="", nullable=True)
    quantization_level: Mapped[str] = mapped_column(String(50), default="", nullable=True)
    modelfile: Mapped[str] = mapped_column(String(1000), default="", nullable=True)
    auto_modelfile: Mapped[str] = mapped_column(String(1000), default="", nullable=True)
    ...
    process_message: Mapped[str] = mapped_column(String(500), default="", nullable=True)
