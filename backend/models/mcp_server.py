...
class MCPServer(db.Base):
    ...
    description_en: Mapped[str] = mapped_column(String(500), nullable=True)
    url: Mapped[str] = mapped_column(String(500), nullable=True)
    command: Mapped[str] = mapped_column(String(1000), nullable=True)
    command_type: Mapped[str] = mapped_column(String(50), default="", nullable=True)
    ...
    install_status: Mapped[str] = mapped_column(String(50), default=MCPStatus.NOT_READY.value, nullable=True)
